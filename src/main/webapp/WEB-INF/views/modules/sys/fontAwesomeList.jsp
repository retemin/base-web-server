...
<ul class="the-icons">
	...
	<li><i class="fa fa-navicon"></i>fa-navicon</li>
	...
	<li><i class="fa fa-turkish-lir"></i>fa-turkish-lir</li>
	...
	<li><i class="fa fa-institution"></i>fa-institution</li>
	<li><i class="fa fa-bank"></i>fa-bank</li>
	<li><i class="fa fa-university"></i>fa-university</li>
	<li><i class="fa fa-mortar-board"></i>fa-mortar-board</li>
	...
	<li><i class="fa fa-jooml"></i>fa-jooml
	<li>
	...
	<li><i class="fa fa-file-photo-o"></i>fa-file-photo-o</li>
	<li><i class="fa fa-file-picture-o"></i>fa-file-picture-o</li>
	<li><i class="fa fa-file-image-o"></i>fa-file-image-o</li>
	<li><i class="fa fa-file-zip-o"></i>fa-file-zip-o</li>
	<li><i class="fa fa-file-archive-o"></i>fa-file-archive-o</li>
	<li><i class="fa fa-file-sound-o"></i>fa-file-sound-o</li>
	<li><i class="fa fa-file-audio-o"></i>fa-file-audio-o</li>
	<li><i class="fa fa-file-movie-o"></i>fa-file-movie-o</li>
	...
	<li><i class="fa fa-life-bouy"></i>fa-life-bouy</li>
	<li><i class="fa fa-life-buoy"></i>fa-life-buoy</li>
	<li><i class="fa fa-life-saver"></i>fa-life-saver</li>
	<li><i class="fa fa-support"></i>fa-support</li>
	<li><i class="fa fa-life-ring"></i>fa-life-ring</li>
	<li><i class="fa fa-circle-o-notch"></i>fa-circle-o-notch</li>
	<li><i class="fa fa-r"></i>fa-r</li>
	<li><i class="fa fa-rebel"></i>fa-rebel</li>
	<li><i class="fa fa-ge"></i>fa-ge</li>
	...
	<li><i class="fa fa-wechat"></i>fa-wechat</li>
	...
	<li><i class="fa fa-soccer-ball-o"></i>fa-soccer-ball-o</li>
	...
	<li><i class="fa fa-cc-vis"></i>fa-cc-vis</li>
